...
<body>
    <div class="wrapper">
        <main class="reg">
            <form class="enter" action="exe/dd_com.php" method="post">
                <h1>Добавление соревнования</h1>
                <input class="form" type="text" name="name" id="name" placeholder="Наименование" required> <br><br>
                <input class="form" type="date" name="date" id="date" placeholder="Дата проведения"> <br><br>
